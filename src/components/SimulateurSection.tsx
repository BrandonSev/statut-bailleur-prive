                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                        <div className="bg-blue-50 rounded-lg px-3 py-2 border border-blue-100">
                          <div className="flex items-center justify-between sm:gap-x-1">
                            <p className="font-bold text-blue-800">Loyer annuel brut</p>
                        ...
                        <div className="bg-blue-50 rounded-lg px-3 py-2 border border-blue-100">
                          <div className="flex items-center justify-between sm:gap-x-1">
                            <p className="text-blue-500 ">
                              <span className="font-bold text-blue-800">Amortissement</span> (
                              {(TAUX_AMORTISSEMENT[niveauLoyer] * 100).toFixed(1)}%/an)
                            </p>
                            <p className="font-bold text-blue-800 text-sm">
                          ...
                          <div className="text-right sm:text-center">
                            <p className="font-bold text-gray-700 text-base flex items-center gap-1 sm:justify-center">
                              ...
                              <Tooltip>
                                ...
                                <TooltipContent side="top" className="max-w-fit text-xs text-left">
                                ...
                                <TooltipContent side="top" className="max-w-fit text-xs">
                                  {r.impotTotalAvec <= 0 ? (
                                    ...
                                    <div className="text-left">
                                      Calcul simplifié :<br /> Revenu foncier = Loyer annuel – 20 % de charges estimées – amortissement annuel
                                      Jeanbrun. <br /> Impôt estimé = Revenu foncier × (TMI sélectionnée + 17,2 %)
                                    </>
                                  )}
                                </TooltipContent>
                              </Tooltip>

...
const faqs = [
  {
    q: "Le statut du bailleur privé (dispositif Jeanbrun) est-il officiellement en vigueur en 2026 ?",
    a: "Oui.\nLe statut du bailleur privé a été instauré par la loi de finances 2026 (article 47), publiée au Journal Officiel le 20 février 2026.\n\nIl s'applique aux acquisitions réalisées (signature de l'acte authentique de vente chez le notaire) entre le 21 février 2026 et le 31 décembre 2028.\n\nDes précisions complémentaires pourront être apportées via la doctrine administrative (BOFiP).",
  },
  {
    q: "Comment fonctionne l'amortissement du statut du bailleur privé ?",
    a: "Le statut du bailleur privé permet de déduire chaque année un pourcentage du prix d'acquisition du logement (hors foncier estimé forfaitairement à 20 %), au titre de l'amortissement fiscal.\nCe mécanisme réduit directement le revenu foncier imposable et diminue l'impôt sur les loyers perçus.",
  },
  {
    q: "Quels logements sont éligibles ?",
    a: "Logements neufs ou en VEFA\n\nLogements issus de réhabilitation lourde\n\nSitués dans un immeuble collectif\n\nLoués nus à usage de résidence principale",
  },
  {
    q: "Le statut du bailleur privé est-il réservé aux zones tendues ?",
    a: "Le dispositif ne repose pas sur un zonage restrictif comparable au Pinel.\nLes plafonds de loyers et de ressources sont adaptés selon la zone du bien, mais l'investissement reste possible sur l'ensemble du territoire sous réserve de respecter les critères d'éligibilité.",
  },
  {
    q: "L'avantage fiscal est-il plafonné ?",
    a: "Oui.\n\nLe montant de l'amortissement déductible est plafonné :\n\n8 000 € par an\n\nMajoré à 10 000 € ou 12 000 € selon la part de logements loués en social ou très social\n\nLe cumul total des amortissements ne peut excéder la valeur du bien hors foncier (forfaitairement estimé à 80 % du prix d'acquisition).",
  },
  {

...
const comparatif = [
  ...
  },
  {
    ...
    bailleur: "9 ans (fixe)",
    pinel: "6, 9 ou 12 ans (modulable)",
  },
  {
    critere: "Plafonds de loyers",
    bailleur: "Oui, par zone et niveau de loyer",
    pinel: "Oui, par zone",
  },
  {
    critere: "Plafonds de ressources",
    bailleur: "Oui, selon le niveau de loyer choisi",
    pinel: "Oui",
  },
  {
    critere: "Zonage",
    bailleur: "Tout le territoire",
    ...
    <section id="comparatif" className="w-full bg-background py-16 md:py-20">
      <div className="max-w-[1100px] mx-auto px-6">
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-b-2 border-border">
                ...
                <TableHead className="py-3.5 text-center font-semibold text-xs uppercase tracking-wide bg-trust-light text-primary">
                  Statut du bailleur privé
                </TableHead>
                <TableHead className="py-3.5 text-center font-semibold text-xs uppercase tracking-wide text-foreground/70">
                  Pinel
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {comparatif.map((row, i) => (
                <TableRow key={i} className={i % 2 === 0 ? "bg-card" : "bg-secondary/40"}>
                  ...
                  <TableCell className="text-center text-sm font-medium py-3 bg-trust-light/50 text-foreground">
                    {row.bailleur}
                  </TableCell>
        ...
        <div className="rounded-2xl border border-primary/15 bg-trust-light p-5 md:p-6 mb-6">
          <h3 className="text-sm font-bold mb-2" style={{ color: "#123768" }}>En résumé</h3>
